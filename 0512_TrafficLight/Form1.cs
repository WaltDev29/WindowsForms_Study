    ...
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            switch (sec % 12)
            {
                ...
                case 1:
                case 2:
                    picBox_light.Image = Properties.Resources.trafficLight_red;
                ...
                case 4:
                case 5:
                    picBox_light.Image = Properties.Resources.trafficLight_yellow;
                    state = 1;
                    break;
                case 6:
                case 7:
                case 8:
                    picBox_light.Image = Properties.Resources.trafficLight_green;
                    state = 2;
                    break;
                case 9:
                case 10:
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                picBox_player.Image = Properties.Resources.guy_right;
                if (x <= 0) return;
            ...
            {
                picBox_player.Image = Properties.Resources.guy_left;
                if (x >= 500) return;
                if (state == 0 && (x + 20 >= 100 && x + 20 <= 450)) return;
                x += 20;
                picBox_player.Location = new Point(x, y);
        ...
        private void playerDead()
        {
            ...
            picBox_player.Image = Properties.Resources.guy_dead;
